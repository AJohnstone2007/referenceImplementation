...
Double.parseDouble(mv[0].trim()),
Double.parseDouble(mv[1].trim()),
Double.parseDouble(mv[2].trim()),
Double.parseDouble(mv[3].trim()),
Double.parseDouble(mv[4].trim()),
Double.parseDouble(mv[5].trim()),
Double.parseDouble(mv[6].trim()),
Double.parseDouble(mv[7].trim()),
Double.parseDouble(mv[8].trim()),
Double.parseDouble(mv[9].trim()),
Double.parseDouble(mv[10].trim()),
Double.parseDouble(mv[11].trim())
));
break;
case float_array:
