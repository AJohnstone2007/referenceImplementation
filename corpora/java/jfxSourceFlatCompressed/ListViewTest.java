...
VirtualFlowTestUtils.assertRowsNotEmpty(list, 0, 5);
VirtualFlowTestUtils.assertRowsEmpty(list, 5, -1);
list.setItems(FXCollections.observableArrayList(
new Person("*_*Emma", "Jones", "emma.jones@example.com"),
new Person("_Michael", "Brown", "michael.brown@example.com")));
VirtualFlowTestUtils.assertRowsNotEmpty(list, 0, 2);
VirtualFlowTestUtils.assertRowsEmpty(list, 2, -1);
}
