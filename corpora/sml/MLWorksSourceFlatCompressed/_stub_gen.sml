...
and validPtr (CfunctionT t) = error "function pointers not yet supported"
...
| sizeOfC _ (CintT (us, BITS n)) = (n mod 8) + 1
...
| outDecl (Cdecl (structName, CstructT sName)) =
...
(if t = "c_double" then outSig ("  type " ^t)
