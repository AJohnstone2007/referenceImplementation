...
datatype display = DISPLAY of int
datatype screen = SCREEN of int
datatype region = REGION of int
datatype widget = WIDGET of int
datatype gc = GC of int
datatype widget_class = WIDGETCLASS of int ref
...
datatype gcontext = GCONTEXT of int
datatype drawable = DRAWABLE of int
datatype cursor = CURSOR of int
datatype colormap = COLORMAP of int
datatype font = FONT of int
datatype keysym = KEYSYM of int
...
datatype ArgRep =
ARGBOOL of bool ref |
ARGBOXED of MLWorks.Internal.Value.T ref |
ARGINT of int ref |
ARGSHORT of int ref |
ARGSTRING of string ref |
ARGUNBOXED of MLWorks.Internal.Value.T ref
in
datatype edit_mode =
