...
val s1 = ""
and s2 = "ABCDE\tFGHI";
val ss1 = Substring.all s1
and ss2 = Substring.all s2;
val sa = "AAAAaAbAABBBB";
val ssa1 = extract(sa, 4, SOME 0)
val ssa2 = extract(sa, 4, SOME 5)
...
val s3 = Substring.substring ("ABCDabcd", 1, 5)
val s4 = Substring.substring ("ABCDabcd", 0, 1)
val s5 = Substring.substring ("ABCDabcd", 1, 0)
