...
public class Chuck {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("(-1) Quit (0) Ramdom joke (n) Joke number n");
		System.out.println("What do you want to do?");

	  int value = keyboard.nextInt();
          while (value != -1) {
	     if ((value < 0) || (value > 344)){
       	 System.out.println("Please enter an integer between -1 and 344"); }
	     else { 
                 if (value == 0) {
...
public static void extra()
	...
	for(int i=1; i<4; i++) {
	  if (i>1) 
            System.out.println("interest rate for year " + i + " will be " + interestRate);
  	  System.out.print("Enter number of cars sold in year " + i + " ");
 	  x = br.nextInt();
	...
	System.out.println("final 3 year profit " + total);
    }
}
...
static int dBTR( ) {
    ...
    while (stop==1) {
	 ...
	 if(x%3==0) { z= x/3; }
             ...
             else  System.out.println("sorry value out of range");
      } 
      System.out.print("enter 0 to terminate or 1 to repeat "); 
      stop = input.nextInt(); }
    return z;
}
}
...
public class Graduate extends Student {
    ...
    public void setStudyYear(int n) {
         System.out.println("Year of study cannot be reset"); }
...
class TelephoneEntry {
    ...
    public String toString() { return  name + "   telephone: " + number ; } }


class TestTelephoneGUI {
  public static void testTel() { 
    TelephoneEntry t = new TelephoneEntry("Henry Brown", 2084713303);
...
class FindLine
{
    public static void findLine()
    {
      ...
      System.out.print("Enter x then y coordinates of first point: ");
