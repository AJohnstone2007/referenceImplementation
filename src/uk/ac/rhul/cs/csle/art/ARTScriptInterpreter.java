...
//@formatter:on
  ...
  private void directiveAction(int term) {
    ...
    case "try":
      ...
      case "file":
        try {
          // System.out.println("Attempting to open file " + iTerms.getTermSymbolString(iTerms.getSubterm(term, 0, 0, 0, 0)));
          doTry("", Files.readString(Paths.get(iTerms.getTermSymbolString(iTerms.getSubterm(term, 0, 0, 0, 0)))), true, true);
        } catch (IOException e) {
