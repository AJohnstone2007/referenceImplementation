...
//@formatter:on
  ...
  public void directiveAction(int term) {
    ...
    case "try":
      ...
      doTry("try", inputString, true, false);
      break;
    case "bootstrapTest":
  ...
  private void builtinTests() {
    ...
    // doTry("", "aaa", false, true);
    // doTry("", "bb", false, true);
    // doTry("", "bbb", false, true);
    // doTry("", "c", false, true);
    // doTry("", "cc", false, true);
    // doTry("", "ccc", false, true);
  ...
  public void interpret(String scriptString) {
    workingGrammar = new Grammar("Working grammar", iTerms); // Set up a fresh grammar for the
