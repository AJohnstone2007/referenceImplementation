...
public abstract class Value {
  ...
  private void operationNotImplemented(String operation) {
    throw new ARTUncheckedException("Value type " + this.getClass().getSimpleName() + " does not provide operation " + operation);
  }

  private void operationNotImplemented(String operation, Value r) {
    throw new ARTUncheckedException("Value type " + this.getClass().getSimpleName() + " does not allow operation " + operation + " with argument " + r);
  }

  private void operationNotImplemented(String operation, Value r, Value rr) {
    throw new ARTUncheckedException(
        "Value type " + this.getClass().getSimpleName() + " does not allow operation " + operation + " with arguments " + r + ", " + rr);
  }
  ...
  public Value __put(Value r) {
    operationNotImplemented("__put(_,_) - check arity", r);
    return null;
  }
